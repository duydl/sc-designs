...
async def sc_add_tb(dut):
    ...
    for i in range(10): # 10 experiments
        ...
        print(f"Test {i}:")
        print(f"Expected Prob: {(pa + pb)/2} \t Prob Output: {pc}")
...
def test_add():
    ...
    run(
        ...
        toplevel="sc_add",    # top level HDL
        
        module="test_add", # name of the file that contains @cocotb.test() -- this file
        simulator="icarus"
